...
?>
<?php
	require_once '../blocks/groups_menu.php';
?>
<div class="groups_salad_main_div">
	<div class="groups_salad_main_title_div"><h1 class="groups_salad_main_title">Diet Meals</h1></div>
	<!--  searchbar -->
	<form action="../search/diet_meals_search.php" method="POST">
	 <div class="wrapper">
		...
		<div class="groups_salad_recipe_main_div">
			<div class="groups_salad_recipe_flex">
				<div class="groups_salad_first_recipe_flex_wrap">
											<?php 
				$result = mysqli_query($connect, query: "SELECT * FROM `diet meals`");
					...
					<div class="groups_salad_content_card_width">
						<div class="groups_salad_content_card">
								...
								<a href="../link/diet_meals_link.php?id=<?php echo $post['id']?>"><img class="groups_salad_content_card_image" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($post['changed image']); ?>"></a>
								</div>
							<div class="groups_salad_content_card_footer">
								...
								<div class="groups_salad_content_card_footer_button_div"><div class="groups_salad_content_card_footer_button"><a class="groups_salad_content_card_footer_href" href="../link/diet_meals_link.php?id=<?php echo $post['id']?>">See More</a></div></div>
							</div>
						</div>			
					</div>
					<?php } ?>
